...
#ifdef USE_Delay
  #include "coocox.h"              /* Header file where the Delay function prototype is exported */
  #define _eth_delay_    CoTickDelay   /* User can provide more timing precise _eth_delay_ function 
